...
public class Conditional {
	...
	public static void main(String[] args) {
		...
		// if문의 블록{} 안 명령어가 한줄이면 블록{}을 생략할 수 있다.
		if (myMoney < price)
			System.out.println("돈이 부족합니다.");
...
//			String warning = "리뷰는 12자 이상 작성하세요";
		...
		} else { // 어차피 크다밖에 안남으니깐 = }else if(numZero > 0) {
			System.out.println("0보다 크다.");
		}

		System.out.println("\n=====================================\n");

		// 리모콘의 전원 버튼의 경우 전원 버튼 하나로 on/off 다 가능하다.
		...
		// boolean의 true/false 값을 스위치에 on/off처럼 사용하는 boolean 타입의 변수를 토글(toggle) 또는
		// 플래그(flag) 변수라고 한다.
		...
		// 92가 80보다 크므로 B로 인식하고 다음 조건문을 안읽는다

		// 순서 신경쓰기는 세상이 팍팍하다. 범위를 명확히 하기
		...
		System.out.println("\n=====================================\n");
		// 회원가입 조건 체크 이름은 한글자 이상 휴대폰 번호는 10자리 또는 11자리
		String name = "가나다";
