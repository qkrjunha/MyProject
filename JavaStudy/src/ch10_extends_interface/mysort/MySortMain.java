...
public class MySortMain {
	...
	public static void main(String[] args) {
		...
		stuList.add(new Student("진영", 79, 81, 76));
		stuList.add(new Student("대일", 86, 86, 76));
		stuList.add(new Student("영민", 81, 85, 71));
		stuList.add(new Student("강호", 88, 72, 97));
		
		
		// 이게 뭐지?? -> 콜백함수
		// 인터페이스(comparator)의 추상메소드(compare)를 미리 다른 메소드(sort)에서
		// 사용하고, 추상메소드(compare)의 구현은 해당 메소드(sort)를 실행하는
		// 쪽에서 구현한다.
