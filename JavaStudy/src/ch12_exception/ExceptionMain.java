...
public class ExceptionMain {
	...
	public static void main(String[] args) {
		// 보통 예외가 발생하는 상황에 대해서 에러가 났다고 표현
		// 현업에서는 뻑났다라고 함.
		...
		try {
			...
			// 예외 처리를 하고자 하는 코드르 선택 후
			// 마우스 우 클릭 - Surround With - try catch 클릭
			try {
		...
		// 콘솔형 프로그램에서 숫자를 입력하지 않으면 다시 입력할수있도록
